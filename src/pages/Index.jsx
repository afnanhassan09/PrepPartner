  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="space-y-8 relative">
              ...
              <h1 className="text-6xl font-bold leading-tight">
                <span className="bg-gradient-to-r from-teal via-primary to-secondary bg-clip-text text-transparent animate-gradient-xy">
                  Master you interview skills with ,
                </span>
                <br />
                realtime feedback,
                <br />
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-8">
                <button
                  ...
                  className="group relative px-8 py-4 bg-primary overflow-hidden rounded-full transition-all duration-300"
                >
                  <div className="absolute inset-0 w-0 bg-teal transition-all duration-[400ms] ease-out group-hover:w-full"></div>
                  <span className="relative text-primary-foreground group-hover:text-white flex items-center justify-center">
                    Start Free Trial
                    <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                  </span>
                </button>

                <button className="relative px-8 py-4 bg-white/80 backdrop-blur-sm rounded-full border border-border hover:border-primary transition-all duration-300 hover:shadow-lg hover:shadow-primary/20">
                  <span className="relative flex items-center justify-center">
                    Watch Demo
                    <span className="ml-2 relative w-5 h-5 flex items-center justify-center">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-20"></span>
                      <span className="relative block w-3 h-3 bg-primary rounded-full"></span>
                    </span>
                  </span>
                </button>
              </div>
              ...
              <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl">
                ...
                >
                  <div className="bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-xl">
                    <div className="text-2xl font-bold text-teal">95%</div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {features.map((feature, index) => (
              <div key={index} className="feature-card relative group">
                {/* Animated background */}
                <div className="absolute -inset-1 bg-gradient-to-r from-primary to-teal rounded-lg blur opacity-25 group-hover:opacity-75 transition duration-1000 group-hover:duration-200"></div>

                {/* Main content */}
                <div className="relative flex flex-col items-center">
                  {/* Floating icon */}
                  <div className="relative w-24 h-24 mb-8">
                    <div className="absolute inset-0 bg-gradient-to-r from-primary to-teal rounded-3xl rotate-6 group-hover:rotate-12 transition-transform duration-300"></div>
                  ...
                  <div className="relative text-center group-hover:-translate-y-2 transition-transform duration-300">
                    <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-teal to-primary bg-clip-text text-transparent">
                      {feature.title}
                    </h3>
                    <p className="text-muted group-hover:text-black transition-colors duration-300">
                      {feature.description}
                    </p>
                  </div>

                  {/* Decorative elements */}
                  <div className="absolute -right-4 -bottom-4 w-20 h-20 bg-primary/5 rounded-full blur-xl group-hover:bg-primary/20 transition-colors duration-300"></div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <span className="px-4 py-2 rounded-full bg-teal/10 text-teal text-sm font-medium mb-4 inline-block">
              Testimonials
            </span>
            <h2 className="text-5xl font-bold bg-gradient-to-r from-teal to-primary bg-clip-text text-transparent mb-4">
              Success Stories
            </h2>
          </div>
          ...
          <div className="success-stories grid md:grid-cols-3 gap-8">
            {successStories.map((story, index) => (
              <div key={index} className="success-story group relative">
                <div className="absolute inset-0 bg-gradient-to-br from-primary to-secondary rounded-3xl opacity-0 group-hover:opacity-10 blur-xl transition-all duration-500"></div>
                <div className="relative bg-white/80 backdrop-blur-sm p-8 rounded-3xl transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-2">
                  <div className="absolute -right-4 -top-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center transform rotate-12 group-hover:rotate-0 transition-transform duration-300">
                  ...
                  <blockquote className="relative mb-6">
                    <div className="absolute -left-2 -top-2 text-4xl text-primary opacity-20">
                      "
                    </div>
                    <p className="text-muted relative z-10 italic pl-4">
                      {story.story}
                    </p>
                  </blockquote>
                  ...
                  <div className="flex space-x-1">
                    {[...Array(story.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="w-5 h-5 text-primary transform transition-all duration-300 group-hover:scale-110 hover:rotate-12"
                        fill="currentColor"
                      />
                    ))}
                  </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="px-4 py-2 rounded-full bg-secondary text-teal text-sm font-medium mb-4 inline-block">
              FAQ
            </span>
            <h2 className="text-5xl font-bold bg-gradient-to-r from-teal to-primary bg-clip-text text-transparent">
              Common Questions
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={index} className="group relative">
                <div className="absolute inset-0 bg-gradient-to-br from-primary to-secondary rounded-3xl opacity-0 group-hover:opacity-10 blur-xl transition-all duration-500"></div>
                <div className="relative bg-white/80 backdrop-blur-sm p-8 rounded-3xl transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-2">
                  <div className="absolute -left-4 -top-4 w-12 h-12 bg-gradient-to-br from-teal to-primary rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                    <span className="text-white font-bold">Q</span>
                  </div>

                  <h3 className="text-xl font-semibold mb-4 text-teal group-hover:text-primary transition-colors duration-300">
                    {faq.q}
                  </h3>
                  <p className="text-muted group-hover:text-black transition-colors duration-300">
                    {faq.a}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-teal/5"></div>

        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 relative">
            {/* Floating elements */}
            <div className="absolute -top-20 -left-20 w-40 h-40 bg-primary/10 rounded-full blur-3xl animate-pulse"></div>
            <div className="absolute -bottom-20 -right-20 w-40 h-40 bg-teal/10 rounded-full blur-3xl animate-pulse"></div>
            ...
            <p className="text-muted text-lg relative z-10">
            ...
            <div className="flex -space-x-4">
              {["John Doe", "Sarah Kim", "Luis Silva"].map((name, index) => (
                <div key={index} className="relative group">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-teal p-1 transform transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12">
                    <div className="w-full h-full rounded-full bg-white flex items-center justify-center text-lg font-bold text-primary">
                      {name[0]}
                    </div>
                  </div>
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-teal/20 rounded-3xl blur-2xl"></div>
            <div className="relative bg-white/50 backdrop-blur-sm rounded-3xl p-8 border border-primary/20">
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-r from-primary/10 to-teal/10"></div>
          <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(243,193,120,0.05)_50%,transparent_75%)] bg-[length:20px_20px] animate-shimmer"></div>
        </div>
          ...
          <div className="space-y-8">
            <h2 className="text-5xl font-bold">
              ...
              <span className="relative inline-block mt-2">
                Next Interview?
                <div className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-primary to-teal"></div>
              </span>
            </h2>
            ...
            <button
              ...
              className="group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden rounded-full bg-gradient-to-r from-primary to-teal transition-all duration-300"
            >
              <div className="absolute inset-0 w-0 bg-white transition-all duration-[400ms] ease-out group-hover:w-full"></div>
              <span className="relative text-white group-hover:text-primary flex items-center">
                Get Started Free

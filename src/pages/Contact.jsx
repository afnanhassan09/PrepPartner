          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl animate-fade-up">
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <label className="flex items-center p-4 border border-border rounded-lg cursor-pointer hover:border-primary transition-all duration-300 bg-background">
                      <input
                        ...
                        className="text-[#F3C178] focus:ring-[#F3C178] mr-3 h-4 w-4"
                      />
                      <span className="text-sm font-medium">Contact via Email</span>
                    </label>
                    <label className="flex items-center p-4 border border-border rounded-lg cursor-pointer hover:border-primary transition-all duration-300 bg-background">
                      <input
                        type="radio"
                        ...
                        className="text-[#F3C178] focus:ring-[#F3C178] mr-3 h-4 w-4"
                      />
                      <span className="text-sm font-medium">Contact via Phone</span>
                    </label>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-[#F3C178] text-white p-4 rounded-lg hover:bg-[#F3C178]/90 transition-all duration-300 flex items-center justify-center space-x-2 group"
                >
                  {isSubmitting ? (
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className="text-[#F3C178] p-4 bg-[#F3C178]/10 rounded-full">
                    {info.icon}
                  </div>
                  <div className="space-y-2">
                    <h3 className="font-semibold text-xl text-teal">{info.title}</h3>
